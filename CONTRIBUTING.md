...
functionality you're adding in your contribution. Check out the [tests](https://github.com/hashicorp/terraform-module-aws-vault-enterprisee/tree/master/test) folder for instructions on running the 
automated tests. 
